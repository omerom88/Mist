...
// */
//public class playerFrus extends Activity {
...
//
//
//        DrawingActivity.whoIsPlaying = "frus";
...
//                    Toast.makeText(playerFrus.this, "Saved your draw in your phone gallery", Toast.LENGTH_SHORT).show();
//                } else {
//                    Toast.makeText(playerFrus.this, "Unable to store the draw", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
//
...
//        alertDialog = new AlertDialog.Builder(playerFrus.this);
...
//                    Toast.makeText(playerFrus.this, "Cannot write images to external storage", Toast.LENGTH_SHORT).show();
//                }
//            }
//        }
//    }
...
//        playerFrus.this.sendBroadcast(mediaScanIntent);
//    }
//
...
//            mediaPlayer.release();
//        }
//        mediaPlayer = MediaPlayer.create(playerFrus.this, songsArray.get(i));
...
//        songsArray.add(0,R.raw.power);
//        songsArray.add(1,R.raw.takemeout);
//        songsArray.add(2,R.raw.runtheworld);
//        songsArray.add(3,R.raw.money);
//        songsArray.add(4,R.raw.gougeaway);
//        songsArray.add(5, R.raw.pandaprodbymenace);
//        return songsArray;
//    }
//    public static ArrayList<String> buildTimeArray(){
//        songsTime.add(0,"1:40");
//        songsTime.add(1,"3:57");
//        songsTime.add(2,"4:04");
//        songsTime.add(3,"6:33");
//        songsTime.add(4,"2:45");
//        songsTime.add(5,"4:08");
//        return songsTime;
//    }
//
//
...
//
////
////    private Button stopButton, pauseButton, playButton, nextBut, beforeBut, mDoneButton ,mClearButton;
////    private LinearLayout clearDoneLay;
////    private MediaPlayer mediaPlayer = new MediaPlayer();
////    private double startTime = 0;
////    private Handler myHandler = new Handler();
...
////    public static ArrayList<Integer> songsArray = new ArrayList<>();
////    public static ArrayList<String> songsTime = new ArrayList<>();
////    private int songCounter = 0, touchLayoutCOunter = 0;
////    private SignaturePad mSignaturePad;
////    public static int fingerOff = 0;
////    public static int numberOfTouches = 0;
////    public static float allPressures = 0;
...
////        beforeBut = (Button)findViewById(R.id.trackBefore);
////        nextBut = (Button)findViewById(R.id.trackAfter);
////        mDoneButton = (Button)findViewById(R.id.button5);
////        mClearButton = (Button)findViewById(R.id.button4);
////        Button setBut = (Button) findViewById(R.id.settingBut);
////        final View themeLayout = findViewById(R.id.themeLayout);
////        themeLayout.setBackground(DrawingActivity.photoDrawable);
...
////        endSec.setTypeface(type);
////
////        themeLayout.setOnTouchListener(new View.OnTouchListener() {
////            @Override
////            public boolean onTouch(View v, MotionEvent event) {
////                touchLayoutCOunter++;
////                if (touchLayoutCOunter == 1) {
////                    themeLayout.setBackgroundColor(Color.GRAY);
...
////                mediaPlayer.stop();
////                mediaPlayer.release();
////                Intent intent1 = new Intent(playerFrus.this, setting.class);
////                startActivityForResult(intent1, 1);
////            }
////        });
////
...
//
//
////        themeLayout.setBackground(getResources().getDrawable(R.drawable.f1));
//
////        track1.setOnClickListener(new View.OnClickListener() {
////            @Override
////            public void onClick(View v) {
////                mediaPlayer.stop();
////                mediaPlayer = MediaPlayer.create(playerFrus.this, R.raw.power);
////                endSec.setText("6:33");
...
////            public void onClick(View v) {
////                mediaPlayer.stop();
////                mediaPlayer = MediaPlayer.create(playerFrus.this, R.raw.takemeout);
////                endSec.setText("3:57");
////                themeLayout.setBackground(getResources().getDrawable(R.drawable.f2));
////                if (MainActivity.pressPlay) {
////                    mediaPlayer.start();
////                    startTime = mediaPlayer.getCurrentPosition();
////                    startSec.setText(String.format("%d:%d",
...
////            public void onClick(View v) {
////                mediaPlayer.stop();
////                mediaPlayer = MediaPlayer.create(playerFrus.this, R.raw.runtheworld);
////                endSec.setText("4:04");
////                themeLayout.setBackground(getResources().getDrawable(R.drawable.f3));
////                if (MainActivity.pressPlay) {
////                    mediaPlayer.start();
////                    startTime = mediaPlayer.getCurrentPosition();
////                    startSec.setText(String.format("%d:%d",
...
////            public void onClick(View v) {
////                mediaPlayer.stop();
////                mediaPlayer = MediaPlayer.create(playerFrus.this, R.raw.money);
////                endSec.setText("6:33");
////                themeLayout.setBackground(getResources().getDrawable(R.drawable.f4));
////                if (MainActivity.pressPlay) {
////                    mediaPlayer.start();
////                    startTime = mediaPlayer.getCurrentPosition();
////                    startSec.setText(String.format("%d:%d",
...
////            public void onClick(View v) {
////                mediaPlayer.stop();
////                mediaPlayer = MediaPlayer.create(playerFrus.this, R.raw.gougeaway);
////                endSec.setText("2:45");
////                themeLayout.setBackground(getResources().getDrawable(R.drawable.f5));
////                if (MainActivity.pressPlay) {
////                    mediaPlayer.start();
////                    startTime = mediaPlayer.getCurrentPosition();
////                    startSec.setText(String.format("%d:%d",
...
////            public void onClick(View v) {
////                mediaPlayer.stop();
////                mediaPlayer = MediaPlayer.create(playerFrus.this, R.raw.pandaprodbymenace);
////                endSec.setText("4:08");
////                themeLayout.setBackground(getResources().getDrawable(R.drawable.f6));
////                if (MainActivity.pressPlay) {
////                    mediaPlayer.start();
////                    startTime = mediaPlayer.getCurrentPosition();
////                    startSec.setText(String.format("%d:%d",
