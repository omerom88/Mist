...
// */
//public class plyerUnmotiv extends Activity {
...
//
//
//        DrawingActivity.whoIsPlaying = "un";
...
//                    Toast.makeText(plyerUnmotiv.this, "Saved your draw in your phone gallery", Toast.LENGTH_SHORT).show();
//                } else {
//                    Toast.makeText(plyerUnmotiv.this, "Unable to store the draw", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
//
...
//        alertDialog = new AlertDialog.Builder(plyerUnmotiv.this);
...
//                    Toast.makeText(plyerUnmotiv.this, "Cannot write images to external storage", Toast.LENGTH_SHORT).show();
//                }
//            }
//        }
//    }
...
//        plyerUnmotiv.this.sendBroadcast(mediaScanIntent);
//    }
//
...
//            mediaPlayer.release();
//        }
//        mediaPlayer = MediaPlayer.create(plyerUnmotiv.this, songsArray.get(i));
