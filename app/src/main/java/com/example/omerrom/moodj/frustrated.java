 ...
 */
public class frustrated extends Activity {
    ...
    public void onResume(){
        super.onResume();
        mSignaturePad.clear();
        mainLay.setBackground(getResources().getDrawable(R.drawable.layout25));
        ...
        mSignaturePad.setOnSignedListener(new SignaturePad.OnSignedListener() {
            ...
            public void onSigned() {
                ...
                Intent intent = new Intent(frustrated.this,playerMood.class);
        ...
        try {
            gifDrawableFrus = new GifDrawable(getResources(), R.drawable.frustratedgif);
