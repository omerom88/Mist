 ...
 */
public class pickColor2 extends Activity {
    ...
    public void onResume(){
        super.onResume();
        mSignaturePad.clear();
        mainLay.setBackground(getResources().getDrawable(R.drawable.layout7));

        mediaPlayer = MediaPlayer.create(pickColor2.this, R.raw.runtheworld);
        mediaPlayer.start();
        ...
        frusPen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    gifDrawableFrus = new GifDrawable(getResources(), R.drawable.runworldred);
                ...
                mainLay.setBackground(getResources().getDrawable(R.drawable.layout8));
                mSignaturePad.setPenColor(Color.parseColor("#e41f26"));
                MainActivity.frusPlaylist.add(R.raw.runtheworld);
                choosen = "frus";
                pickedColor = true;
            }
        });
        ...
        chillPen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    gifDrawableFrus = new GifDrawable(getResources(), R.drawable.runwolrdgreen);
                    gifDrawableFrus.addAnimationListener(new AnimationListener() {
                        @Override
                        public void onAnimationCompleted(int loopNumber) {
                            gifDrawableFrus.stop();
                ...
                im.setBackground(gifDrawableFrus);
                mainLay.setBackground(getResources().getDrawable(R.drawable.layout10));
                mSignaturePad.setPenColor(Color.parseColor("#05aa4b"));
                MainActivity.chillPlaylist.add(R.raw.runtheworld);
                pickedColor = true;
                choosen = "chill";
            }
        });
        ...
        unPen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    gifDrawableFrus = new GifDrawable(getResources(), R.drawable.runworldblue);
                    gifDrawableFrus.addAnimationListener(new AnimationListener() {
                        @Override
                        public void onAnimationCompleted(int loopNumber) {
                            gifDrawableFrus.stop();
                ...
                im.setBackground(gifDrawableFrus);
                mainLay.setBackground(getResources().getDrawable(R.drawable.layout9));
                mSignaturePad.setPenColor(Color.parseColor("#4b5eaa"));
                MainActivity.unPlaylist.add(R.raw.runtheworld);
                pickedColor = true;
                choosen = "un";
            }
        });
            ...
            public void onSigned() {
                if (pickedColor) {
                    if (choosen.equals("frus")) {
                        MainActivity.frusPlaylist.add(0, R.raw.runtheworld);
                    } else if (choosen.equals("frus")) {
                        MainActivity.chillPlaylist.add(0, R.raw.runtheworld);
                    } else {
                        MainActivity.unPlaylist.add(0, R.raw.runtheworld);
                    }
                    mediaPlayer.stop();
                    mediaPlayer.seekTo(0);
                    Intent intent = new Intent(pickColor2.this, pickColor3.class);
