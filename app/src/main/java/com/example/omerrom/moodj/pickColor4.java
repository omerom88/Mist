 ...
 */
public class pickColor4 extends Activity {
    ...
    public void onResume(){
        super.onResume();
        mSignaturePad.clear();
        mainLay.setBackground(getResources().getDrawable(R.drawable.layout15));

        mediaPlayer = MediaPlayer.create(pickColor4.this, R.raw.beckwow);
        mediaPlayer.start();
        ...
        frusPen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    gifDrawableFrus = new GifDrawable(getResources(), R.drawable.wowred);//// TODO: 15/06/2017 change to RED!!
                ...
                mainLay.setBackground(getResources().getDrawable(R.drawable.layout16));
        ...
        chillPen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    gifDrawableFrus = new GifDrawable(getResources(), R.drawable.wowgreen);
                    gifDrawableFrus.addAnimationListener(new AnimationListener() {
                        @Override
                        public void onAnimationCompleted(int loopNumber) {
                            gifDrawableFrus.stop();
                ...
                im.setBackground(gifDrawableFrus);
                mainLay.setBackground(getResources().getDrawable(R.drawable.layout18));
        ...
        unPen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    gifDrawableFrus = new GifDrawable(getResources(), R.drawable.wowblue);
                    gifDrawableFrus.addAnimationListener(new AnimationListener() {
                        @Override
                        public void onAnimationCompleted(int loopNumber) {
                            gifDrawableFrus.stop();
                ...
                im.setBackground(gifDrawableFrus);
                mainLay.setBackground(getResources().getDrawable(R.drawable.layout17));
            ...
            public void onSigned() {
                if (pickedColor) {
                    if (choosen.equals("frus")) {
                        MainActivity.frusPlaylist.add(0, R.raw.beckwow);
                    } else if (choosen.equals("frus")) {
                        MainActivity.chillPlaylist.add(0, R.raw.beckwow);
                    } else {
                        MainActivity.unPlaylist.add(0, R.raw.beckwow);
                    }
                    mediaPlayer.stop();
                    mediaPlayer.seekTo(0);
                    Intent intent = new Intent(pickColor4.this, pickColor5.class);
